...
export const SpeakerCard = () => {
  ...
  return (
    <button
      className="flex flex-col px-4 w-80 py-10 items-center text-center gap-2 border-4 rounded-md transition ease-in-out duration-300 bg-white hover:scale-125"
